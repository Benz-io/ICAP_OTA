...
const char* WIFI_SSID = "Teddy_Bear_2.4G";
const char* WIFI_SECRET = "ultraman";
...
String getHostName(String url) {
    ...
    Serial.println("Host Name: " + hostName);
    return hostName;
}
...
void reconnect() {
    while (!mqtt.connected()) {
        ...
        if (mqtt.connect("ESP32Clientwserdtfyghjnjkjkgjiksfdjdktmsgdbjh")) {
